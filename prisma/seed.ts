...
const PERMISSIONS: Array<{ code: string; module: string; description: string }> = [
  ...
  { code: 'student.update', module: 'student', description: 'Update student profiles and data' },
  { code: 'student.delete', module: 'student', description: 'Remove students' },
  ...
  { code: 'term.update', module: 'term', description: 'Modify term dates or status' },
  { code: 'term.delete', module: 'term', description: 'Delete upcoming terms' },

  // Section (schedules and capacity are covered by section.update)
  { code: 'section.read', module: 'section', description: 'View course sections and schedules' },
  { code: 'section.create', module: 'section', description: 'Create course sections per term' },
  { code: 'section.update', module: 'section', description: 'Modify section schedule, capacity or teacher' },
  ...
  { code: 'enrollment.update', module: 'enrollment', description: 'Modify or drop student enrollments' },
  ...
  { code: 'assessment.update', module: 'assessment', description: 'Modify assessment details' },
  { code: 'assessment.grade', module: 'assessment', description: 'Grade student submissions' },
  { code: 'assessment.delete', module: 'assessment', description: 'Delete assessment plans' },
